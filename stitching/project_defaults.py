...
_FALLBACK_NATIVE_DISTORTION_MODE = "runtime-lines"
_FALLBACK_NATIVE_USE_SAVED_DISTORTION = True
_FALLBACK_NATIVE_DISTORTION_AUTO_SAVE = True
...
_FALLBACK_NATIVE_DISTORTION_LENS_MODEL_HINT = "auto"

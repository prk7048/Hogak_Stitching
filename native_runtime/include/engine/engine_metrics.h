...
struct EngineMetrics {
    ...
    int64_t output_pending_frames = 0;
    int64_t output_queue_capacity = 0;
    std::string output_drop_policy;
    ...
    int64_t production_output_pending_frames = 0;
    int64_t production_output_queue_capacity = 0;
    std::string production_output_drop_policy;
